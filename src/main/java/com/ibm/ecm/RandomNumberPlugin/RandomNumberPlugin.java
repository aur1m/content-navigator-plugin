 ...
 * <p>
 */
public class RandomNumberPlugin extends Plugin {
	...
	public String getConfigurationDijitClass() {
		return "RandomNumberPluginDojo.ConfigurationPane";
	}
